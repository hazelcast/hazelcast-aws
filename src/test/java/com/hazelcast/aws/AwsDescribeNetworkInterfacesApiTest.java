...
public class AwsDescribeNetworkInterfacesApiTest {
    ...
    public void setUp() {
        ...
        awsDescribeNetworkInterfacesApi = new AwsDescribeNetworkInterfacesApi(endpoint, AWS_CONFIG, requestSigner,
            CLOCK);
    }

    @Test
    public void privateToPublicAddresses() {
        // given
        ...
        // when
        Map<String, String> result = awsDescribeNetworkInterfacesApi.publicAddresses(privateAddresses, REGION, CREDENTIALS);
