...
public class Configuration {
    ...
    public String toString() {
        return "Configuration{enabled=" + this.enabled + ", region=\'" + this.region + '\'' + ", securityGroupName=\'" + this.securityGroupName + '\'' + ", tagKey=\'" + this.tagKey + '\'' + ", tagValue=\'" + this.tagValue + '\'' + ", hostHeader=\'" + this.hostHeader + '\'' + ", iamRole=\'" + this.iamRole + '\'' + ", connectionTimeoutSeconds=" + this.connectionTimeoutSeconds + '}';
    }
}
